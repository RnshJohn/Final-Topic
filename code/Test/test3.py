...
print(
    "This is a tool for composing melodies to given chord sequences with a LSTM Recurrent Neural Network that has already been trained.")
print(
    "It has been created in Fall 2015 by Konstantin Lackner under the supervision of Thomas Volk and Prof. Diepold at the Chair of Data Processing at the Technical University of Munich (TUM).")
...
print(
    "Put the chord sequences in MIDI format in the directory: %s. Nothing else but the MIDI files should be in that directory!" % (
        chord_dir))
...
resolution_factor = int(
    input('Resolution Factor (recommended=12):'))  # 24: 1/8 Resolution, 12: 1/16 Resolution, 6: 1/32 Resolution
